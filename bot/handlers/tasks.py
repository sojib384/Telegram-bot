...
class CreateTaskStates(StatesGroup):
    ...
    entering_description_text = State() # Text after photo (2-step)
...
# Step 3 → Photo received → store photo, ask for text separately
